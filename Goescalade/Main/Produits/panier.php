...
<html style="font-size: 16px;" lang="fr"><head>
    ...
    <meta name="description" content="Panier du site">
    <title>Panier</title>
...
try {
    ...
    $ids = array_keys($_SESSION['cart']);
    $idsString = implode(',', $ids);
    $data = $pdo->query("SELECT * FROM produits WHERE id IN (". $idsString .")")->fetchAll();
       ...
       <div class="u-align-center u-container-style u-products-item u-repeater-item u-white u-repeater-item-1">
         <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1">
           ...
           <h4 class="u-product-control u-text u-text-1">
             <a class="u-product-title-link"> <?= $row['nom'] . $row['référence']; ?> 
           </h4>
...
<button type="button" onclick="AjoutPanier()" class="u-border-2 u-border-grey-75 u-btn u-btn-rectangle u-button-style u-none u-product-control u-text-body-color u-btn-1" >Go Panier</button>
     ...
     function AjoutPanier(articleId){
        $.ajax({
            ...
            success: function(response){
                ...
                setTimeout(function() {
                    window.location.replace("/main/Go-Escalade.php");
                }, 1200);
