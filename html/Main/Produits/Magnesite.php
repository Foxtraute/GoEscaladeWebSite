...
<html style="font-size: 16px;" lang="fr"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="​Go Escalad​e !, Magnesite">
    <meta name="description" content="Magnesite">
    <title>Magnesite</title>
...
try {
    ...
    $data = $pdo->query("SELECT * FROM produits WHERE catégorie='magnesite'")->fetchAll();
