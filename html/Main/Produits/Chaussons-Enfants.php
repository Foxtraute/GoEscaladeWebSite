...
<html style="font-size: 16px;" lang="fr"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="​Go Escalad​e !, Chaussons Enfants">
    <meta name="description" content="Chaussons Enfants">
    <title>Chaussons Enfants</title>
    <link rel="stylesheet" href="../../nicepage.css" media="screen">
    <link rel="stylesheet" href="Chaussons Enfants.css" media="screen">
...
<body class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-image u-sticky u-header" id="sec-aa9f" data-image-width="1920" data-image-height="1080"><div class="u-clearfix u-sheet u-sheet-1">
  ...
  <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
    <h1 class="u-custom-font u-font-ubuntu u-text u-text-default u-text-1">Chaussons Enfants</h1> 
  </div>
...
try {
    ...
    $data = $pdo->query("SELECT * FROM produits WHERE catégorie='chaussons enfants'")->fetchAll();
