...
<html style="font-size: 16px;" lang="fr"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="​Go Escalad​e !, Promotion">
...
try {
    ...
    $data = $pdo->query("SELECT * FROM produits WHERE catégorie='promotions'")->fetchAll();
...
<section class="u-align-center u-clearfix u-section-1" id="sec-7cae">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <h1 class="u-custom-font u-font-ubuntu u-text u-text-default u-text-1">Promotions</h1>
      </div>
</section>
