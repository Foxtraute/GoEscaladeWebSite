...
<html style="font-size: 16px;" lang="fr"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="​Go Escalad​e !, Chaussons Hommes">
    <meta name="description" content="Chaussons Hommes">
    <title>Chaussons Hommes</title>
...
<section class="u-align-center u-clearfix u-section-1" id="sec-7cae">
  <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
    <h1 class="u-custom-font u-font-ubuntu u-text u-text-default u-text-1">Chaussons Hommes</h1> 
  </div>
</section>
...
try {
    ...
    $data = $pdo->query("SELECT * FROM produits WHERE catégorie='chaussons hommes'")->fetchAll();
